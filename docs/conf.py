...
"""
xblock-limesurvey documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-limesurvey',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/xblock-limesurvey",
...
#
# html_title = 'xblock-limesurvey v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'LimeSurvey service for tutor',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'limesurvey'),
                os.path.join(root_path, 'limesurvey/migrations')])
